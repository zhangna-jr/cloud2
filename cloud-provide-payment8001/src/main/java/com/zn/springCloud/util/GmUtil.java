...
import com.dhcc.sm.sm2.SM3Digest;
...
//        // sm2 encrypt and decrypt test ---------------------
        ...
        BigInteger d = new BigInteger("69357311860877944274501233056249066028365600420044873830094634290489872423070", 10);
        BCECPrivateKey bcecPrivateKey = getPrivatekeyFromD(d);
        PublicKey publicKey1 = getPublickeyFromXY(new BigInteger("35ee21e2e4dbf6c729439d57f7bdd513c42f5ca65f53ed41b56353dce68f885a", 16), new BigInteger("fbbccb68ffffb5fbe133985d42ec81dac39513961982cc1657dfe00ed9d5626e", 16));
        //PublicKey publicKey = getPublickeyFromXY(new BigInteger("8e811b2fe033844a37a314622d810abe9e767a9f54195e7a15a70c28f01f161a", 16), new BigInteger("fa914034e486725059a3ddd5b7b3873df9d9897c44f8c91f7394e169f834c2d", 16));
        //BCECPrivateKey privateKey = getPrivatekeyFromD(new BigInteger("10167070874317074462968249447381028622625913222903925352686609558071841850430",10));


        byte[]bs1 = sm2Encrypt("sz".getBytes(), publicKey1);
        System.out.println(Hex.toHexString(bs1));
...
/*SM2 sm2 = new SM2();
        ...
        System.out.println("public key q:" + ((BCECPublicKey) publicKey).getQ()); //{x, y, zs...}
